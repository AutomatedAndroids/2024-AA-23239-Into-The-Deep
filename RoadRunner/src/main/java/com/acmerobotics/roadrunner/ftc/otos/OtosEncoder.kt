package com.acmerobotics.roadrunner.ftc.otos
...
class OtosEncoder(private val otos: SparkFunOTOS, private val useYDirection: Boolean, private val reversed: Boolean, private val anyDummyMotor: DcMotor) :
    Encoder {
